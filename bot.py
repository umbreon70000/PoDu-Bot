...
##########################################
    ...
    if message.content.startswith(',event'):
        ...
        strUtc = str(newUtc)
        eventTime = '2018-04-23 07:59:00' #This is the time when the event ends, the one I change
        FMT = '%Y-%m-%d %H:%M:%S'
        if eventTime > strUtc:
...
##########################################
    ...
    #     game=True
    #     await client.send_message(message.channel,"Guess started")
    #     while game:
    #         pokemon = "sceptile"
    #         if message.content.startswith(',treecko'):
    #             game=False
    #             await client.send_message(message.channel,"You lose! Do not say evolutions")
    #         if message.content.startswith(',sceptile'):
